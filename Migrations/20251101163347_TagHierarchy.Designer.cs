...
namespace VideoLibrary.Migrations
{
    ...
    [Migration("20251101163347_TagHierarchy")]
    partial class TagHierarchy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoLibrary.Models.Bookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("VideoId", "TimeInSeconds")
                        .HasDatabaseName("ix_bookmarks_video_id_time_in_seconds");
            ...
            modelBuilder.Entity("VideoLibrary.Models.ContentTag", b =>
                {
            ...
            modelBuilder.Entity("VideoLibrary.Models.Transcription", b =>
                {
                    ...
                    b.HasIndex("VideoId")
                        .IsUnique()
                        .HasDatabaseName("ix_transcriptions_video_id");
            ...
            modelBuilder.Entity("VideoLibrary.Models.Bookmark", b =>
                {
                    b.HasOne("VideoLibrary.Models.Video", "Video")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_bookmarks_videos_video_id");
            ...
            modelBuilder.Entity("VideoLibrary.Models.ContentTag", b =>
                {
                    b.HasOne("VideoLibrary.Models.Content", "Content")
                        .WithMany("ContentTags")
                        .HasForeignKey("ContentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_content_tags_contents_content_id");
                    ...
                    b.HasOne("VideoLibrary.Models.Tag", "Tag")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_content_tags_tags_tag_id");
            ...
            modelBuilder.Entity("VideoLibrary.Models.Transcription", b =>
                {
                    b.HasOne("VideoLibrary.Models.Video", "Video")
                        ...
                        .HasForeignKey("VideoLibrary.Models.Transcription", "VideoId")
                        .HasConstraintName("fk_transcriptions_videos_video_id");
